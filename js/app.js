...
let OpenCards = [];//Array to hold the open Cards
const cardSymbols = ["fa-diamond",
  "fa-paper-plane-o",
  "fa-anchor",
  "fa-bolt",
  "fa-cube",
...
function AddCardSymbols() {
  deck.innerHTML = '';
  let cardContent = '';
  for (symbol of cardSymbols) {
    cardContent += `<li class="card"> <i class="fa ${symbol}"></i> </li>`;
  }
...
for (card of deckOfcards) {
  card.addEventListener('click', function flipCard() {
    const flippedCard = this.classList.add("open", "show");
    return flippedCard;
